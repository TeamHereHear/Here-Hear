//
//  OpenInAnotherMusicAppView.swift
//  Here-Hear
//
//  Created by Martin on 4/9/24.
//

import SwiftUI

struct OpenInAnotherMusicServiceView: View {
    ...
    var body: some View {
        HStack {
            ...
            if let appleMusicIconImage = UIImage(named: "AppleMusicIcon"),
               let url = URL(string: "music://music.apple.com/kr/album/magnetic/1734500886?i=1734500896") {
                Button {
                    Task {
...
#Preview {
    OpenInAnotherMusicServiceView(music: .onBoardingPageStubOne)
}
